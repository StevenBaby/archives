...
$$
\frac{1}{1 - x} = \sum_{n=0}^{\infty} (-1)^n x^n = 1 + x + x^2 + \cdots + x^n + \cdots , -1 < x < 1
$$
...
$$
\cos x =  \sum_{n=0}^{\infty} (-1)^n \frac{x^{2n}}{(2n)!} = x - \frac{x^2}{2!} + \cdots + (-1)^n \frac{x^{2n}}{(2n)!} + \cdots, -\infty < x < + \infty
$$
