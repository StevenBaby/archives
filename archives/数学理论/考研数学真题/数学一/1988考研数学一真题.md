...
(3) 设 $\Sigma$ 为曲面 $x^2 + y^2 + z^2 = 1$ 的外侧，计算曲面积分 $\displaystyle I = \oiint\limits_\Sigma x^3 dydz + y^3 dzdx + z^3 dxdy$
...
<img class='ui image' src="./images/1988-1.svg" style='max-width: 500px'/>
