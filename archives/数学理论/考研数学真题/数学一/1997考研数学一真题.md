...
(1) 二元函数 $f(x,y) = \begin{cases} \displaystyle {xy \over x^2 + y^2}, & (x,y) \neq (0,0) \\ 0, & (x,y) = (0,0) \\ \end{cases}$，在点 $(0,0)$ 处
...
(3) 设 $\displaystyle F(x) = \int_x^{x + 2\pi} e^{\sin t} \sin tdt$，则 $F(x)$
...
(4) 设 $\displaystyle \boldsymbol{\alpha}_1 = \begin{bmatrix} a_1 \\ a_2 \\ a_3 \end{bmatrix}$, $\displaystyle \boldsymbol{\alpha}_1 = \begin{bmatrix} b_1 \\ b_2 \\ b_3 \end{bmatrix}$, $\displaystyle \boldsymbol{\alpha}_1 = \begin{bmatrix} c_1 \\ c_2 \\ c_3 \end{bmatrix}$，则三条直线
