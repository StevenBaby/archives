...
设向掀组 $\boldsymbol{\alpha}_1,\boldsymbol{\alpha}_2,\boldsymbol{\alpha}_3$ 为 $R^3$ 的一个基，$\boldsymbol{\beta}_1 = 2\boldsymbol{\alpha}_1 + 2k\boldsymbol{\alpha}_3$，$\boldsymbol{\beta}_2 = 2\boldsymbol{\alpha}_2$，$\boldsymbol{\beta}_3 = \boldsymbol{\alpha}_1 + (k + 1)\boldsymbol{\alpha}_3$
