...
(1) 将函数 $\displaystyle f(x) = \arctan {1 + x \over 1 - x}$ 展为 $x$ 的幂级数

(2) 求八分之一球面 $\displaystyle x^2 + y^2 + z^2=R^2,$ $x\geqslant 0,y\geqslant 0,z\geqslant 0$ 的边界曲线的重心，设曲线的线密度 $\rho=1$

(3) 设空间区域 $\Omega$ 由曲面 $z=a^2-x^2-y^2$ 与平面 $z=0$ 围城，其中 $a$ 为正常数，记 $\Omega$ 表面的外侧为 $S$，$\Omega$ 的体积为 $V$，证明：

$$
\iint\limits_S x^2yz^2 dydz - xy^2z^2dzdx + z(1 + xyz) dxdy = V
$$
